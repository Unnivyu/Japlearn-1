...
import styles from '../styles/stylesCharacterMenu';
...
const levels = [
    { id: '', title: 'Lesson' }, //Chaange the route once screen is available
    { id: '', title: 'Character Game 1' }, //Chaange the route once screen is available
    { id: '', title: 'Character Game 2' } //Chaange the route once screen is available
];
